...
extern class UserWindow {
	...
	public function createWindow(?options:Dynamic):titanium.desktop.ui.UserWindow;
	 ...
	 * @since	0.5.0
	 */
	public function getContextMenu():titanium.desktop.ui.Menu;
	...
	public function getDOMWindow():Void;
	 ...
	 * @since	0.3.0
	 */
	public function getParent():titanium.desktop.ui.UserWindow;
	 ...
	 * @since	1.1.0
	 */
	public function setPluginsEnabled(enabled:Bool):Void;
