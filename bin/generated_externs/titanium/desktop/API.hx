...
import titanium.desktop.api.Component;
import titanium.desktop.api.Application;
import titanium.desktop.api.Dependency;
/**
...
extern class API {
	 ...
	 * @return	titanium.desktop.api.Dependency
	 * @since	0.4.0
	 */
	public static function createDependency(type:Float, name:String, version:String, ?requirement:Float):titanium.desktop.api.Dependency;
	 ...
	 * @return	titanium.desktop.api.Application
	 * @since	0.2.0
	 */
	public static function getApplication():titanium.desktop.api.Application;
	 ...
	 * @since	0.4.0
	 */
	public static function readApplicationManifest(manifestPath:String, ?applicationPath:String):titanium.desktop.api.Application;
