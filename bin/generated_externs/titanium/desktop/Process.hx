...
import titanium.desktop.SubProcess;
import titanium.desktop.Pipe;
/**
...
extern class Process {
	 ...
	 */
	public static function createProcess(args:Array<String>, ?envionment:Dynamic, ?pipeIn:Pipe, ?pipeOut:Pipe, ?pipeErr:Pipe):SubProcess;
