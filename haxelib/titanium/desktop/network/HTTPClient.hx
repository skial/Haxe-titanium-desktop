...
extern class HTTPClient {
	 ...
	 * @since	0.7.0
	 */
	public function getCookie(name:String):titanium.desktop.network.HTTPCookie;
	 ...
	 * @since	0.8.0
	 */
	public function getResponseHeaders():Array<Array<Dynamic>>;
	 ...
	 * @since	0.3.0
	 */
	public function sendFile(file:titanium.desktop.filesystem.File):String;
