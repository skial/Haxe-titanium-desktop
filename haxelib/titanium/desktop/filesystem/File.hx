...
extern class File {
	 ...
	 * @since	1.1.0
	 */
	public function open(?mode:Float, ?binary:Bool, ?append:Bool):titanium.desktop.filesystem.Filestream;
	 ...
	 * @since	0.2.0
	 */
	public function parent():titanium.desktop.filesystem.File;
	 ...
	 * @since	0.2.0
	 */
	public function resolve(subPath:String):titanium.desktop.filesystem.File;
