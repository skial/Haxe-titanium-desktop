## Appcelerator Titanium Desktop for Haxe ##
...
## Appcelerator Titanium Mobile for Haxe ##

If you are looking for extern classes for Titanium Mobile you can it from haxelib ```haxelib install titanium-api``` or download from github https://github.com/visup/haxe-titanium-api
